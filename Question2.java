...
//Raja Hammad Mehmood.
//The modification in this program prints the entire tree using a pre-order traversal and post order
// traversal besides the built in in-order traversal.
...
public class Question2 {
	...
	static void preorderPrint(TreeNode node) {
		if (node != null) { // (Otherwise, there's nothing to print.)
			System.out.println(node.item + " "); // Print the root item.
